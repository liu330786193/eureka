...
public class ActiveSpanTagActivation extends ClassStaticMethodsEnhancePluginDefine {
    ...
    public static final String ENHANCE_CLASS = "com.lyl.eureka.plugin.springmvc.annotation.ActiveSpan";
    public static final String INTERCEPTOR_CLASS = "com.lyl.eureka.plugin.springmvc.annotation.activation.ActiveSpanTagInterceptor";
