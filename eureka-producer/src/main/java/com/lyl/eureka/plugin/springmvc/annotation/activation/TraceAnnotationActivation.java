...
import com.lyl.skywalking.plugin.interceptor.enhance.ClassInstanceMethodsEnhancePluginDefine;
import com.lyl.skywalking.plugin.match.ClassMatch;
import net.bytebuddy.description.method.MethodDescription;
import net.bytebuddy.matcher.ElementMatcher;

import static com.lyl.skywalking.plugin.match.MethodAnnotationMatch.byMethodAnnotationMatch;
...
public class TraceAnnotationActivation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    public static final String TRACE_ANNOTATION_METHOD_INTERCEPTOR = "com.lyl.eureka.plugin.springmvc.annotation.activation.TraceAnnotationMethodInterceptor";
    public static final String TRACE_ANNOTATION = "com.lyl.eureka.plugin.springmvc.annotation.Trace";
